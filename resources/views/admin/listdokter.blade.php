...
@section('header')<div class="navbar  bg-neutral">
    ...
    <div class="navbar-center hidden lg:flex">
      <ul class="menu menu-horizontal p-0">
        ...
        <li class="text-white"><a href="listdokter" class="btn btn-ghost normal-case text-xl">Dokter</a></li>
        <li><a href="listobat" class="btn btn-ghost normal-case text-xl">Obat</a></li>
        <li><a href="riwayat" class="btn btn-ghost normal-case text-xl">Riwayat</a></li>
      </ul>
    </div>
