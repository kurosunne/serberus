                        ...
                        <thead class="text-base-100">
                            <tr>
                                <th class="bg-secondary"><a
                                        href="{{ route('pasien.historiperawat', $sort_link['id']) }}">No</a>
                                ...
                                <th class="bg-secondary"> <a
                                        href="{{ route('pasien.historiperawat', $sort_link['tanggal']) }}">Tanggal Janji</a>
                                ...
                                <th class="bg-secondary"> <a
                                        href="{{ route('pasien.historiperawat', $sort_link['perawat']) }}">Perawat</a>
                                ...
                                <th class="bg-secondary"><a
                                        href="{{ route('pasien.historiperawat', $sort_link['status']) }}">Status</a>
