                        ...
                        <thead class="text-base-100">
                            <tr>
                                <th class="bg-secondary"><a
                                        href="{{ route('pasien.historitemu', $sort_link['id']) }}">No</a>
                                ...
                                <th class="bg-secondary"> <a
                                        href="{{ route('pasien.historitemu', $sort_link['tanggal']) }}">Tanggal Janji</a>
                                ...
                                <th class="bg-secondary"> <a
                                        href="{{ route('pasien.historitemu', $sort_link['dokter']) }}">Dokter</a>
                                ...
                                <th class="bg-secondary"><a
                                        href="{{ route('pasien.historitemu', $sort_link['status']) }}">Status</a>
