    ...
    <div class="h-full flex justify-center items-center">
        <div class="bg-base-100 h-[35rem] w-[65rem] rounded-lg flex border-black" style="border: 4px solid #2596be">
            ...
            <div class="h-full w-1/2 p-5 items-center flex flex-col">
                ...
                <p class="text-1.5xl text-sky-600 mt-3">Bukan Perawat?</p>
                <div class="flex flex-row mt-3 justify-between w-4/5">
                    {{-- Menuju halaman login pasien --}}
                    <a href="{{ route('login.indexpasien') }}" class=" w-2/5 max-w-md "><button
                            class="btn btn-secondary w-full max-w-md text-base-100">Saya Pasien</button></a>
                    {{-- Menuju halaman login dokter --}}
                    <a href="{{ route('login.indexdokter') }}" class=" w-2/5 max-w-md "><button
                            class="btn bg-white btn-outline btn-secondary w-full max-w-md text-base-100">Saya
                            Dokter</button></a>
                </div>
            </div>
            ...
            <form method="POST" class="h-full w-1/2 bg-secondary rounded-tr-lg rounded-br-lg flex flex-col items-center">
                ...
                <a href="{{ route('register.perawat') }}" class="w-full max-w-md mt-2">
                    <div class="btn btn-base-100 btn-outline w-full text-base-100">Register</div>
                </a>
            </form>
