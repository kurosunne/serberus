                        ...
                        <thead class="text-base-100">
                            ...
                            <tr>
                                <th class="bg-secondary">
                                    <a href="{{ route('dokter.riwayat', $sort_link['id']) }}">No</a>
                                ...
                                <th class="bg-secondary">
                                    <a href="{{ route('dokter.riwayat', $sort_link['pasien']) }}">Pasien</a>
                                ...
                                <th class="bg-secondary">
                                    <a href="{{ route('dokter.riwayat', $sort_link['tanggal']) }}">Tanggal Janji</a>
